 ...
 * @author Willian
 */
public class BuscaPorFaixaEspecificaDepartamento extends javax.swing.JDialog {

    /**
     * Creates new form ResumoDepartamentoBusca
     */
    public BuscaPorFaixaEspecificaDepartamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        Resultado.setText(Controle.buscarFaixaDepartamento(Minimo, Maximo));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaPorFaixaEspecificaDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaPorFaixaEspecificaDepartamento dialog = new BuscaPorFaixaEspecificaDepartamento(new javax.swing.JFrame(), true);
